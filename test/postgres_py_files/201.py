...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (46273477,46273478,81893,75580,46269847,46269843)
...
-- End Condition Occurrence Criteria
  ...
  WHERE (OP.OBSERVATION_PERIOD_START_DATE + 0*INTERVAL'1 day') <= E.START_DATE AND (E.START_DATE + 7*INTERVAL'1 day') <= OP.OBSERVATION_PERIOD_END_DATE
) P
-- End Primary Events
) pe
) QE
