...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (201820,442793,443238)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (201254,4058243,435216,40484648)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (40769338,43021173,42539022,46270562)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
