...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (377889,40484010,434046,379831,433496,40659147)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (376793)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
