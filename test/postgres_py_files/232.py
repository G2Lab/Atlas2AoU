...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (4236484,4090425,4009389,4115411)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (136184,4169287)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
