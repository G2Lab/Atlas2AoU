...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (4276586,44783356,439727)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (4013105,432554)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (4013105)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
