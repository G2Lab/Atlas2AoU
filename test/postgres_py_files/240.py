...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (79908,4319324,4317279,73001,81286,4345578,4263710,4102023,439142,137967)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (434657)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
