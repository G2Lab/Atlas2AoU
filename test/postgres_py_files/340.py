...
( 
  select concept_id from ukbb.CONCEPT where concept_id in (140214,40481101,4082588,4297361)
...
LEFT JOIN
(
  select concept_id from ukbb.CONCEPT where concept_id in (45766714,4134132,140168,4148876,4029043,432791)
UNION  select c.concept_id
  from ukbb.CONCEPT c
  join ukbb.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
