...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (79908,4319324,4317279,73001,81286,4345578,4263710,4102023,439142,137967)
...
left join
(
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (434657)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
