...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (4236484,4090425,4009389,4115411)
...
left join
(
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (136184,4169287)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
