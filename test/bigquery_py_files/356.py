...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (4051478,4049224,4082142,4096682)
...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (45768610,4262407,4055146,45772698)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
