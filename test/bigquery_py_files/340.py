...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (140214,40481101,4082588,4297361)
...
left join
(
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (45766714,4134132,140168,4148876,4029043,432791)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
