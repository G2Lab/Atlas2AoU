...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (314664,4008859)
...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (4224848,40479232,4161597,4049219,44783199,36714606)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
