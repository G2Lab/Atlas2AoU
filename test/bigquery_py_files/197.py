...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (43020660,4185932,37109911,4177223,4127089,37109912,319038,42537729,438172,316995,4108678,4124687,45766165,4108220,4058723,44783188,4080593,4108215,4108680,37109910,318443,44809539,45766212,37312532)
