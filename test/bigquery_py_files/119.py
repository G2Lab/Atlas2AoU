...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (255891,4300204,4319305,4145240,37016279,46273369)
...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (1777087,1551099,1506270,1550557,1305058,19014878,40236987,1101898,19003999)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from {os.environ["WORKSPACE_CDR"]}.concept where concept_id in (255891,4300204,4319305,4145240,37016279,46273369,439777,140214,45766714,74125,77074,194133,4272240,78517,138525,80809)
union distinct select c.concept_id
  from {os.environ["WORKSPACE_CDR"]}.concept c
  join {os.environ["WORKSPACE_CDR"]}.concept_ancestor ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (255891,4300204,4319305,4145240,37016279,46273369)
